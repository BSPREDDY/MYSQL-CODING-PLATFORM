...
// Grant re-entry to a locked out user
// export async function grantContestReEntry(userId: string, contestId: string) {
// 	try {
// 		const session = await verifySession();
...
// 		console.log("updatingggggggggg", result);

// 		if (!result.length) {
// 			return {
// 				success: false,
// 				error: "No locked out record found for this user and contest",
// 			};
// 		}
...
// 			success: false,
// 			error:
// 				error instanceof Error ? error.message : "Failed to grant re-entry",
// 		};
// 	}
// }
//using route
...
// Fix the getAllLockedOutUsers function to properly fetch locked out users
