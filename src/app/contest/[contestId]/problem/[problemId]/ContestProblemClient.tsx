...
export function ContestProblemClient({
	...
	// Update the handleRunCode function to better handle the test case results
	const handleRunCode = async () => {
		...
		try {
			...
			//  results object for test case outcomes for TestCasePanel
			...
			console.log("Panel results being set:", { panelResults });
			...
			<div className="flex w-screen h-screen bg-zinc-50 text-zinc-900 p-0 m-0 overflow-hidden">
					...
					<div className="h-full overflow-auto">
						<div className="max-w-3xl mx-auto p-6">
							...
							<div className="flex items-center justify-between mb-6">
								...
								{contestEndTime && (
									<div className="flex items-center gap-2 text-zinc-700 bg-zinc-100 px-3 py-1.5 rounded-md">
										<Clock size={16} />
				...
				>
					...
					<div className="flex-1 flex flex-col h-full overflow-hidden">
						...
						>
							{/* Editor Panel with  overflow handling */}
							...
							{/* Test Cases Panel with  overflow handling */}
							<div
