...
// 		// Initialize empty test cases array if none provided
...
// 	// Ensure test cases are properly parsed
// 	let testCases = [];

// 	// Check if testCases exists and is an array
// 	if (problem.testCases && Array.isArray(problem.testCases)) {
// 	  testCases = problem.testCases;
// 	}
// 	// Check if testCases is a string (possibly JSON-encoded)
// 	else if (problem.testCases && typeof problem.testCases === 'string') {
// 	  try {
