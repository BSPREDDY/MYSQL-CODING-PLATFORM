...
// import { grantContestReEntry } from "@/app/actions/contest-security";
...
// 				// Remove the user from the table (optimistic UI update)
// 				const userRow = document.getElementById(`user-row-${userId}`);
// 				if (userRow) {
// 					userRow.classList.add("animate-fade-out");
// 					setTimeout(() => {
...
// 	// Keep users state in sync with props
// 	useEffect(() => {
...
// 				// Remove the user from the local state (optimistic UI update)
