...
// // New table for contest lockouts
// export const contestLockouts = pgTable("contest_lockouts", {
// 	id: uuid("id").defaultRandom().primaryKey(),
// 	contestId: uuid("contest_id")
// 		.notNull()
// 		.references(() => contests.id, { onDelete: "cascade" }),
...
// export type NewContestSubmission = InferInsertModel<typeof contestSubmission>;
// export type NewContestPoint = InferInsertModel<typeof contestPoints>;
// export type NewContestLockout = InferInsertModel<typeof contestLockouts>;
