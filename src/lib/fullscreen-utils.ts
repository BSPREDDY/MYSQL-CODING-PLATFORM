...
export function isInFullScreen(): boolean {
	...
	// Additional check for screen dimensions
	...
	// This helps with some browsers/OS combinations where the fullscreenElement check might fail
...
// Exit full-screen mode with better error handling
