...
// import { Avatar, AvatarFallback } from "@/components/ui/avatar"
// import { Separator } from "@/components/ui/separator"
// import { ArrowLeft, Calendar, Mail, Trophy, CheckCircle2, XCircle, BarChart3, Pencil, User, Shield } from "lucide-react"
// import {
//   getUserById,
//   getUserSubmissions,
//   getUserContestParticipation,
...
//   // Fetch user solved problems (unique problems solved)
//   const solvedProblemsResult = await getUserSolvedProblems(userId)
//   const solvedProblems = solvedProblemsResult.success ? solvedProblemsResult.data : 0

//   return (
//     <div className="space-y-6">
//       <div className="flex items-center gap-2">
//         <Link href="/admin/users" className="inline-flex items-center text-muted-foreground hover:text-foreground">
//           <ArrowLeft className="mr-2 h-4 w-4" />
//           Back to Users
//         </Link>
//       </div>
...
//               <UserStats
//                 totalSubmissions={submissions.length}
//                 acceptedSubmissions={submissions.filter((sub) => sub.status === "AC").length}
//                 totalContests={contests.length}
...
//                 <CardHeader>
//                   <CardTitle>Performance Overview</CardTitle>
//                   <CardDescription>User's performance statistics and trends</CardDescription>
//                 </CardHeader>
//                 <CardContent className="h-80">
//                   <UserStatsChart userId={userId} />
//                 </CardContent>
...
//                   <CardHeader>
//                     <CardTitle>Recent Submissions</CardTitle>
//                     <CardDescription>Latest problem submissions</CardDescription>
//                   </CardHeader>
//                   <CardContent>
//                     <UserSubmissionsTable submissions={submissions.slice(0, 5)} />
//                   </CardContent>
//                 </Card>
...
//                   <CardHeader>
//                     <CardTitle>Contest Participation</CardTitle>
//                     <CardDescription>Recent contests and performance</CardDescription>
//                   </CardHeader>
//                   <CardContent>
//                     <UserContestsTable contests={contests.slice(0, 5)} />
//                   </CardContent>
...
//                 <CardHeader>
//                   <CardTitle>All Submissions</CardTitle>
//                   <CardDescription>Complete submission history for this user</CardDescription>
//                 </CardHeader>
//                 <CardContent>
//                   <UserSubmissionsTable submissions={submissions} />
//                 </CardContent>
...
//                 <CardHeader>
//                   <CardTitle>Contest History</CardTitle>
//                   <CardDescription>All contests this user has participated in</CardDescription>
//                 </CardHeader>
//                 <CardContent>
//                   <UserContestsTable contests={contests} />
//                 </CardContent>
...
//     <div className="space-y-3">
//       <div>
//         <h3 className="text-sm font-medium text-muted-foreground mb-1">Submissions</h3>
//         <div className="flex justify-between items-center">
//           <span className="text-2xl font-bold">{totalSubmissions}</span>
//           <div className="flex items-center">
//             <span className="text-sm">{acceptanceRate}%</span>
...
//       <div>
//         <h3 className="text-sm font-medium text-muted-foreground mb-1">Contests</h3>
//         <div className="flex justify-between items-center">
//           <span className="text-2xl font-bold">{totalContests}</span>
//           <Trophy className="h-5 w-5 text-amber-500" />
//         </div>
...
//       <div>
//         <h3 className="text-sm font-medium text-muted-foreground mb-1">Solved Problems</h3>
//         <div className="flex justify-between items-center">
//           <span className="text-2xl font-bold">{solvedProblems}</span>
//           <BarChart3 className="h-5 w-5 text-blue-500" />
//         </div>
//       </div>
//     </div>
