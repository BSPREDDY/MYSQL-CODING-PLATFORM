...
// import { getStudentPerformance } from "@/app/actions/adminUsers";
...
// 		setLoading(true);
// 		try {
// 			const result = await getStudentPerformance(selectedContests, section);
// 			if (result.success) {
...
// 			"Success Rate",
// 		];
// 		const rows = performanceData.map((student) => [
// 			student.rank,
// 			student.name,
// 			student.regNo || "N/A",
// 			student.section || "N/A",
...
// 		link.setAttribute(
// 			"download",
// 			`performance_report${section ? `_section_${section}` : ""}.csv`
// 		);
...
// 			<Card>
// 				<CardHeader>
// 					<CardTitle>Select Contests to Analyze</CardTitle>
// 					<CardDescription>
...
// 								/>
// 								<Label htmlFor={contest.id} className="cursor-pointer">
// 									{contest.title}
// 								</Label>
// 							</div>
// 						))}
...
// 													{!section && <TableHead>Section</TableHead>}
...
// 														<TableCell>{student.successRate}%</TableCell>
// 													</TableRow>
// 												))}
// 											</TableBody>
// 										</Table>
